      ...
      <div className='w-full lg:w-1/4 bg-white px-4'>
        {/* Search Filter from Hero component */}
        {
            isSearched && (searchFilter.title !== "" || searchFilter.location !== "") && (
                ...
                <div className='mv-4 text-gray-600'>
                    {searchFilter.title  && (
        ...
        <button onClick={e=> setSearchFilter(prev => !prev)} className='px-6 py-1.5 rounded border border-gray-400 lg:hidden'>
        ...
        <section className='w-full lg:w-3/4 text-gray-800 max-lg:px-4'>
            <h3 className='font-medium text-3xl py-4' id='job-list'>Latest jobs</h3>
